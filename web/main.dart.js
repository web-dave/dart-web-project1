...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, ship, t2;
      for (t1 = type$.Iterable_dynamic._as(A.getShips()), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
        ship = t1.get$current();
        t2 = document.querySelector("#output");
        if (t2 != null)
          J.insertAdjacentHtml$4$treeSanitizer$validator$x(t2, "beforeend", "<h3>" + A.S(ship.get$name(ship)) + "</h3>", null, null);
      }
    },
    getShips() {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$returnValue = J.get$result$x(B.C_JsonCodec.decode$2$reviver(0, A.encodingForCharset(A._contentTypeForHeaders(response.headers).parameters._collection$_map.$index(0, "charset")).decode$1(0, response.bodyBytes), null));
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  (function inheritance() {
    ...
    _inheritMany(A.SvgElement, [A.FEBlendElement, A.FEColorMatrixElement, A.FEComponentTransferElement, A.FECompositeElement, A.FEConvolveMatrixElement, A.FEDiffuseLightingElement, A.FEDisplacementMapElement, A.FEFloodElement, A.FEGaussianBlurElement, A.FEImageElement, A.FEMergeElement, A.FEMorphologyElement, A.FEOffsetElement, A.FESpecularLightingElement, A.FETileElement, A.FETurbulenceElement, A.ScriptElement0]);
