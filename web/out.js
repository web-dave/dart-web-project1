...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        t1, ship, t2, $async$temp1, $async$temp2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$temp1 = J;
              $async$temp2 = type$.Iterable_dynamic;
              $async$goto = 2;
              return A._asyncAwait(A.getShips(), $async$main);
            case 2:
              // returning from await.
              t1 = $async$temp1.get$iterator$ax($async$temp2._as($async$result));
            case 3:
              // for condition
              if (!t1.moveNext$0()) {
                // goto after for
              ...
              if (t2 != null)
                J.insertAdjacentHtml$4$treeSanitizer$validator$x(t2, "beforeend", "<h3>" + A.S(J.get$name$x(ship)) + "</h3>", null, null);
              // goto for condition
              $async$goto = 3;
              break;
            case 4:
    ...
    getShips() {
      ...
      var $async$getShips = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.get(A._Uri__makeHttpUri("https", "swapi.dev", "api/starships", null)), $async$getShips);
            case 3:
              // returning from await.
              response = $async$result;
              $async$goto = 4;
              return A._asyncAwait(J.get$results$x(B.C_JsonCodec.decode$2$reviver(0, A.encodingForCharset(A._contentTypeForHeaders(response.headers).parameters._collection$_map.$index(0, "charset")).decode$1(0, response.bodyBytes), null)), $async$getShips);
            case 4:
              // returning from await.
      ...
      return A._asyncStartSync($async$getShips, $async$completer);
    }
  },
  J = {
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.NativeByteBuffer, A.NativeTypedData, A.EventTarget, A.Blob, A.DomError, A.DomException, A.DomImplementation, A.Event, A.Location, A.NavigatorUserMediaError, A._NodeList_JavaScriptObject_ListMixin, A.OverconstrainedError, A.SpeechRecognitionResult, A.__NamedNodeMap_JavaScriptObject_ListMixin, A.__SpeechRecognitionResultList_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.ButtonElement, A.EmbedElement, A.FieldSetElement, A.FormElement, A.IFrameElement, A.InputElement, A.MapElement, A.MetaElement, A.ObjectElement, A.OutputElement, A.ParamElement, A.SelectElement, A.SlotElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement, A.TextAreaElement]);
    ...
    _inheritMany(A.Event, [A.ProgressEvent, A.SpeechRecognitionEvent, A.SpeechSynthesisEvent]);
